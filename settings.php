    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="p-6 overflow-y-auto">
            ...
            <form method="POST" class="space-y-4" id="profileForm">
                ...
                <div>
                    <label class="block mb-1 text-white">Username</label>
            ...
            <h2 class="text-xl font-semibold mt-8 mb-6 text-white">Change Password</h2>
            <form method="POST" class="space-y-4" id="passwordForm">
                <input type="hidden" name="action" value="change_password">
                <div>
                    <label class="block mb-1 text-white">Old Password</label>
                    <input name="old_password" type="password" required
                           class="w-full px-3 py-2 bg-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block mb-1 text-white">New Password</label>
                    <input name="new_password" type="password" required
                           class="w-full px-3 py-2 bg-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block mb-1 text-white">Confirm New Password</label>
